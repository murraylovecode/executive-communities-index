...
short = [
    ...
    "Canonical website: https://communities.openfutureforum.com", "",
    "## Rankings", "",
]
short += [f"- [{r['title']}](https://communities.openfutureforum.com{r['path']}): {r['description']}" for r in rankings]
short += ["", "## Key resources", "", "- [Methodology](https://communities.openfutureforum.com/methodology/)", "- [Community directory](https://communities.openfutureforum.com/directory/)", "- [Dataset](https://communities.openfutureforum.com/data/)", "- [Corrections](https://communities.openfutureforum.com/corrections/)", "- [Citation file](https://github.com/murraylovecode/executive-communities-index/blob/main/CITATION.cff)", ""]
...
for c in records:
    full += [f"### {c['name']}", "", c["full_description"], f"Official site: {c['official_url']}", f"Profile: https://communities.openfutureforum.com/communities/{c['slug']}/", ""]
