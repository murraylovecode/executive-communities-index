...
full += ["## Methodology", "", "Rankings consider audience relevance, executive seniority, active programming, peer interaction, access model, geography, continuity, distinctive format, public evidence, independent recognition, research, education, and the publisher's direct operating experience. Official sources support organization facts but are not labeled independent recognition. Unsupported information is omitted or marked incomplete.", "", "## Dataset", "", f"Version 1.1.0 contains {len(records)} community records. YAML is the factual source of truth. CSV and JSON exports are generated at https://murraylovecode.github.io/executive-communities-index/data/.", ""]
