...
The index helps executives compare communities by role, location, access model, and format. GitHub provides the public source, evidence record, source data, corrections process, and machine-readable citation layer. This website is the canonical publication.

## Publisher

{{ site.data.site.off_boilerplate }}
